...
exports.EquivalentXml = (function(){
  ...
  var compare_nodes = function(node_1, node_2, opts){
    var result;
    if( _.any([node_1,node_2], isNotNodeOrAttribute) ){
  ...
  var isNodeOrAttribute = function(node){
    return typeof node == "object" && node !== null && (typeof node.nodeType == "number" || node.constructor === Attr);
  };

  var isNotNodeOrAttribute = function(node){
    return !isNodeOrAttribute(node);
  };
